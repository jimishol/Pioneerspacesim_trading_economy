...
local makeAdvert = function (station)
	...
	local a_exp = 2.42328282947206
	local con_exp = 10^9
	local cargo_exp = Game.player.totalCargo*1 --increased assumed cargo, without decreasing for fuel, in order to compencate for increased price of military fuel.
	local profit = math.max(0.25*1.3*(1.80*con_exp/cargo_exp)^((1-a_exp)/a_exp)*(3*con_exp/4)*3/4, 4337.25*3/4) -- last 3/4 is for getting that ratio of average trading profit and 4337.25 the average minimum efficient trading profit.
