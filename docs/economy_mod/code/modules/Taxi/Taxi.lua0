...
local makeAdvert = function (station)
	...
	local a_exp = 2.42328282947206
        ...
        local profit = math.max(0.25*1.3*(1.80*con_exp/cargo_exp)^((1-a_exp)/a_exp)*(3*con_exp/4)*2/3, 4337.25*2/3) -- last 2/3 is for getting that ratio of average trading profit and 4337.25 is the minimum profit from efficient trading.
